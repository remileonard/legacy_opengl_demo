...
static const yytype_uint8 yyprhs[] =
{
      ...
      21,    23,    25,    28,    30,    31,    35,    37,    40,    42,
      44,    46,    48,    50,    52,    55,    57,    60
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      11,     0,    -1,    12,    14,    -1,    14,    -1,    13,    -1,
      12,    13,    -1,     5,    -1,     6,    -1,     7,    -1,    19,
      -1,    20,    -1,    15,    -1,    14,    15,    -1,     1,    -1,
      -1,     9,    16,    17,    -1,    18,    -1,    17,    18,    -1,
      20,    -1,     3,    -1,     5,    -1,     6,    -1,     7,    -1,
      19,    -1,     4,    20,    -1,     8,    -1,    20,     8,    -1,
      -1
};
...
{
       0,    40,    40,    41,    44,    45,    47,    53,    59,    65,
      76,    84,    89,    95,   103,   102,   115,   116,   119,   133,
     144,   149,   154,   159,   172,   183,   187,   196
};
#endif
...
{
  "$end", "error", "$undefined", "MENU", "POPUP", "COLOR", "BACKCOLOR",
  "HIGHCOLOR", "ACTION", "TITLE", "$accept", "starting", "defaults",
  "default", "buttons", "button", "@1", "commands", "command", "popup",
  "actions", 0
};
#endif
...
{
       0,    13,    27,     6,     7,     8,    25,    14,     0,     0,
       4,     3,    11,     9,    10,    24,    27,     1,     5,     2,
      12,    26,    19,    20,    21,    22,    15,    16,    23,    18,
      17
};
...
{
       1,   -16,    -5,   -16,   -16,   -16,   -16,   -16,    13,     1,
     -16,    14,   -16,   -16,    17,    17,    12,   -16,   -16,    14,
     -16,   -16,   -16,   -16,   -16,   -16,    12,   -16,   -16,    17,
     -16
};
...
{
      15,    28,     1,     6,    20,     2,     3,     4,     5,     6,
       7,    28,    20,    17,    29,    22,     2,    23,    24,    25,
       6,     0,    30,     7,    29,    21,     0,    18,    19
};

static const yytype_int8 yycheck[] =
{
       2,    16,     1,     8,    11,     4,     5,     6,     7,     8,
       9,    26,    19,     0,    16,     3,     4,     5,     6,     7,
       8,    -1,    26,     9,    26,     8,    -1,     9,     9
};
...
static const yytype_uint8 yystos[] =
{
      ...
      13,    14,    15,    19,    20,    20,    16,     0,    13,    14,
      15,     8,     3,     5,     6,     7,    17,    18,    19,    20,
      18
};
...
#line 48 "parser.y"
    {
		    do_color((yyvsp[(1) - (1)].string), selected->default_color, ".color.");
...
#line 54 "parser.y"
    {
		    do_color((yyvsp[(1) - (1)].string), selected->default_backcolor, ".backcolor.");
		    do_color((yyvsp[(1) - (1)].string), selected->backcolor, ".backcolor.");
		    (yyval.b) = NULL;
		;}
    break;
...
#line 60 "parser.y"
    {
		    do_color((yyvsp[(1) - (1)].string), selected->default_highcolor, ".highcolor.");
...
#line 66 "parser.y"
    {
			if (selected->popup == NULL)
				selected->popup = (yyvsp[(1) - (1)].p);
			else
			{
				(yyvsp[(1) - (1)].p)->next = selected->popup;
				selected->popup = (yyvsp[(1) - (1)].p);
			}
			(yyval.b) = NULL;
		;}
...
#line 90 "parser.y"
    {
			(yyvsp[(2) - (2)].b)->next = (yyvsp[(1) - (2)].b);
			buttons_input = (yyvsp[(2) - (2)].b) ;
			(yyval.b) = (yyvsp[(2) - (2)].b);
		;}
    break;
...
#line 103 "parser.y"
    {
			...
			current_button = new_button((yyvsp[(1) - (1)].string));
			(yyval.b) = current_button;
		;}
    break;
...
#line 120 "parser.y"
    {
			...
			{	/* No actions before... */
				current_button->action = (yyvsp[(1) - (1)].string);
			}
			else if ((yyvsp[(1) - (1)].string) != NULL)
			{	/* Add to list of actions */
				char *cat_strings();
				cat_strings(current_button->action,	";");
				cat_strings(current_button->action, (yyvsp[(1) - (1)].string));
			}
			(yyval.string) = NULL;
		;}
    break;
...
#line 134 "parser.y"
    {
			...
			current_button->submenu = strip((yyvsp[(1) - (1)].string));
			(yyval.string) = NULL;
		;}
    break;
...
#line 145 "parser.y"
    {
			do_color((yyvsp[(1) - (1)].string), current_button->color, ".color.");
			(yyval.string) = NULL;
		;}
    break;
...
#line 150 "parser.y"
    {
			do_color((yyvsp[(1) - (1)].string), current_button->backcolor, ".backcolor.");
			(yyval.string) = NULL;
		;}
    break;
...
#line 155 "parser.y"
    {
			do_color((yyvsp[(1) - (1)].string), current_button->highcolor, ".highcolor.");
			(yyval.string) = NULL;
		;}
    break;
...
#line 160 "parser.y"
    {
			if (current_button->popup == NULL)
				current_button->popup = (yyvsp[(1) - (1)].p);
			else
			{
				(yyvsp[(1) - (1)].p)->next = current_button->popup;
				current_button->popup = (yyvsp[(1) - (1)].p);
			}
			(yyval.string) = NULL;
		;}
...
#line 173 "parser.y"
    {
			...
			p->title = (yyvsp[(1) - (2)].string) +1; /* +1 to account for space after .popup. */
			p->action = (yyvsp[(2) - (2)].string);
			p->next = NULL;
			(yyval.p) = p;
		;}
    break;
...
#line 188 "parser.y"
    {	/* Return strings separated by ';' */
			char *t, *cat_strings();
			t = cat_strings((yyvsp[(1) - (2)].string), ";");
			t = cat_strings(t, (yyvsp[(2) - (2)].string));
