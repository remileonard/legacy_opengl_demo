...
#ifdef SP_IRIS_GL
static flot32 planet_material[] = {AMBIENT,  0.08, 0.08, 0.08, DIFFUSE,   1.00, 1.00,  1.00,
                                   SPECULAR, 0.00, 0.00, 0.00, SHININESS, 0.00, LMNULL};

static flot32 infinite_viewer[] = {AMBIENT, 0.08, 0.08, 0.08, LOCALVIEWER, 0.0, LMNULL};

static flot32 infinite_light[] = {AMBIENT, 0.08,     0.08, 0.08, LCOLOR, 1.00, 1.00,
                                  1.00,    POSITION, 0.00, 0.00, -1.00,  0.00, LMNULL};
#endif
