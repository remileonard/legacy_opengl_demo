...
typedef struct  { flot32 s,t     ; }  T2 ;
typedef struct  { flot32 x,y,z   ; }  P3 ;
typedef struct  { flot64 x,y,z   ; }  D3 ;
typedef struct  { flot32 x,y,z,w ; }  P4 ;
typedef struct  { flot32 r,g,b   ; }  C3 ;
typedef struct  { flot32 x,y,z   ; }  V3 ;
typedef struct  { flot32 x,y,z,w ; }  V4 ;
typedef struct  { flot32 r,g,b,a ; }  C4 ;
